...
import { swapErc20LitAction, litAuthAction } from "./actions";
...
let litAction = "";
let mintedPKP = {
    "tokenId": "24653697409524762996131545321830576076561086552599311682809241108357484123544",
    "publicKey": "0x04cd16edc2af2b0905a23a98eae7af63c082d995a42d894094a5fd4f68e9092fbaa3207c835985e1a60d41b987d8dcf0adafe2db36d50089fa8291d8ad049883cb",
    "ethAddress": "0x5D70C9390bC8E22247E26102297CD341228f5189"
}
...
export async function createYourPkp() {
    console.log("minting started..");
    const signerA = await getWallet();
    ...
    const ipfsCID_A = await uploadLitActionToIPFS(litAuthAction);
